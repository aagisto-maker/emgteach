...
class MvcTab(QWidget):
    ...
    def _build_entry_panel(self) -> QWidget:
        ...
        for paragraph in (
            ...
            tr(
                "The reference is a brief, explosive maximal jerk of the "
                "movement the muscle makes, not a sustained push against "
                "something fixed. On the forearm, the flexor's is a jerk of "
                "wrist flexion with the fist clenched with all one's strength, "
                "and the extensor's a jerk of wrist extension with the hand "
                "open and the fingers stretched out as far as they go. A "
                "surface electrode on the forearm does not see one muscle but "
                "the compartment beneath it, finger flexors or extensors "
                "included, and a reference is only a yardstick if it recruits "
                "the same muscle mass as the task. The agonist/antagonist "
                "task includes a grip: clenching the fist brings in the finger "
                "flexors, whereas a push of the wrist leaves them out and, "
                "because the forearm has to be braced, switches on the "
                "antagonist as well."
            ),
            tr(
