...
_ES = {
    ...
    'Next: «{button}», to drop any contraction that did not come out well. If they are all good there is nothing left to do.': 'Siguiente: «{button}», para quitar las contracciones que no salieran bien. Si todas están bien, ya no queda nada que hacer.',
